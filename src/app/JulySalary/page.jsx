...
const JulySalary = () => {
  ...
  useEffect(() => {
    !isclicked
      ? (document.title =
          "Amta West Circle Primary Teachers' Association:All Teacher's July Salary Data")
      : (document.title =
          "Amta West Circle Primary Teachers' Association:All WBTPTA Teacher's July Salary Data");
