...
const DisplayComplain = () => {
          ...
          onClick={(e) => {
            ...
            if (typeof window !== "undefined") {
              document.getElementById("staticBackdropLabel").innerHTML =
                `Complain of Visitor ${row.tname}`;
              document.getElementById("name").innerHTML =
                `Complain of Visitor:-<br/> ${row.tname}`;
              document.getElementById("school").innerHTML =
                `School of Visitor:-<br/> ${row.school}`;
              document.getElementById("sis").innerHTML =
                `Circle of Visitor:-<br/> ${row.sis}`;
              document.getElementById("email").innerHTML =
                `Email of Visitor:-<br/> ${row.email}`;
              document.getElementById("mobile").innerHTML =
                `Mobile No. of Visitor:-<br/> ${row.mobile}`;
              document.getElementById("complain").innerHTML =
                `Complain  of Visitor:-<br/> ${row.complain}`;
              document.getElementById("remark").value = row.remarks;

              if (row.status !== "Not Solved") {
                document.getElementById("noticed").innerHTML =
              ...
              document.getElementById("reg").innerHTML =
                `Complain Registered On:-<br/> ${date.getDate()}-${date.getMonth()}-${date.getFullYear()} At ${
  ...
  useEffect(() => {
    document.title = "Amta West Circle Primary Teachers' Association:Requests";
    userData();
  }, []);
